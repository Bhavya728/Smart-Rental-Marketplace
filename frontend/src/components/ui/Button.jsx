...
const Button = forwardRef(({ 
  ...
  const baseStyles = 'relative overflow-hidden inline-flex items-center justify-center font-semibold rounded-xl transition-all duration-200 ease-out focus:outline-none focus:ring-3 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transform hover:scale-[1.02] active:scale-[0.98] shadow-lg hover:shadow-xl active:shadow-md touch-manipulation';
  
  const sizeStyles = {
    xs: 'px-2.5 py-1.5 text-xs min-h-[32px] sm:px-3 sm:min-h-[28px]', // Larger touch targets on mobile
    sm: 'px-4 py-2.5 text-sm min-h-[40px] sm:py-2 sm:min-h-[36px]',
    md: 'px-6 py-3.5 text-sm font-medium min-h-[48px] sm:py-3 sm:min-h-[44px]',
    lg: 'px-8 py-4.5 text-base font-semibold min-h-[56px] sm:py-4 sm:min-h-[52px]',
    xl: 'px-10 py-5.5 text-lg font-bold min-h-[64px] sm:py-5 sm:min-h-[60px]'
  };
